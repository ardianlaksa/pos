...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MenuPhoto(title: 'Flutter Upload'),
    );
  }
}

class MenuPhoto extends StatefulWidget {
  MenuPhoto({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _MyMenuPhotoState createState() => _MyMenuPhotoState();
}

class _MyMenuPhotoState extends State<MenuPhoto> {
